...
func (rb *ResourceBuilder) SetMackerelioHostID(val string) {
	if rb.config.MackerelioHostID.Enabled {
		rb.res.Attributes().PutStr("mackerelio.host.id", val)
	}
}
...
func (rb *ResourceBuilder) SetMackerelioHostURL(val string) {
	if rb.config.MackerelioHostURL.Enabled {
		rb.res.Attributes().PutStr("mackerelio.host.url", val)
	}
}
...
func (rb *ResourceBuilder) SetMackerelioOrgName(val string) {
	if rb.config.MackerelioOrgName.Enabled {
		rb.res.Attributes().PutStr("mackerelio.org.name", val)
	}
}
